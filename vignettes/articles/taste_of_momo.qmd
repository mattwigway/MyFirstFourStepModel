...
cp_pm_network_flows = network_assignment(
  model,
  model$scenarios$future,
  model$networks$baseline,
  cp_modeflows,
  "PM Peak"
)
...
#| echo: false
#| include: false
cpw_pm_network_flows = network_assignment(
  model,
  model$scenarios$future,
  model$networks$widen,
  cp_modeflows,
  "PM Peak"
)
```
