...
I then have an assignment where all students run and interpret the output of a four-step model. I provide the students with an R file, all of the code of which is included inline in this section to run the model (slightly modified from the last time I taught this assignment due to changes in the package).
