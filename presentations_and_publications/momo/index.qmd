...
- The most common model is the _four-step model_
...
- In 720, I do _one lecture_ on modeling
- Then, every student runs a _very_ simple model and interprets the inputs and outputs
